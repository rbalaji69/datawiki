...
public interface WikiDataEntityRepo extends JpaRepository<WikiDataEntity, String>{
	...
	@Transactional
	@Modifying
	@Query(value = "update wikidata.entity_articles set reign1=:reign1, reign_start=:reign_start, reign_end=:reign_end, status=:status where entity_id = :entity_id", nativeQuery = true)
	...
	public Optional<WikiDataEntity> findByEntityId(String entityId); 
